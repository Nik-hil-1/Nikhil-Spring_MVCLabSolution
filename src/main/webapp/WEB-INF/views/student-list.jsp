        ...
        <tbody>
            <c:forEach items="${Students}" var="tempStudent">
                <tr>
                    ...
                    <td>
                        <a href="/CollegeDebate/showFormForUpdate?studentId=${tempStudent.id }" class="btn btn-info btn-sm">Update</a>
                        <a href="/CollegeDebate/delete?studentId=${tempStudent.id }" class="btn btn-danger btn-sm" onclick="if (!(confirm('Are you sure you want to delete this student record?'))) return false">Delete</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>   
